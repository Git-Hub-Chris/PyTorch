...
libtorch_nativert_sources = [
    ...
    "torch/csrc/nativert/passes/pass_manager/GraphPasses.cpp",
    "torch/csrc/nativert/passes/pass_manager/PassManager.cpp",
    "torch/csrc/nativert/passes/SubgraphRewriter.cpp",
